...
from offlinerlkit.policy_trainer import HybridMBPolicyTrainer
from offlinerlkit.policy import HybridRAMBOPolicy
...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="rambo_hybrid")
...
def train(args=get_args()):
    ...
    policy_trainer = HybridMBPolicyTrainer(
        policy=policy,
        eval_env=env,
