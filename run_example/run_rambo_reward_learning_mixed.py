...
def get_args():
    ...
    parser.add_argument("--use-real-batch-in-policy-update", action="store_true", help="whether to use real policy data in MB policy update.")
...
def train(args=get_args()):
    ...
    # if load dynamics is specified, then set the load reward to the same directory
    if args.load_dynamics_path is not None:
        args.load_reward_path = args.load_dynamics_path
